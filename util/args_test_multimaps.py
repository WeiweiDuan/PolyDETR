...
#     add -f to avoid the error
    ...
    parser.add_argument('--map_name', default='CA_InyoMtns', type=str,
                       help='map names for prediction')
    parser.add_argument('--png_map_dir', default='/data/weiweidu/data/validation_png', type=str,
                       help='the dir to png map and label images')
    parser.add_argument('--tif_map_dir', default='/data/weiweidu/data/validation', type=str,
                       help='the dir to tif map and label images')
    parser.add_argument('--pred_dir', default='/data/weiweidu/data/validation_pred', type=str,
    ...
    # Model path
    parser.add_argument('--trained_model_path', default='/data/weiweidu/PolyDETR_load_img_from_folder_color_aug/trained_models/thrust_fault_line_color_aug_all.pth',
    ...
    parser.add_argument('--vote_thres', default=10, type=int,
